...
if __name__ == '__main__':
    ...
    # 初始化QLib环境：配置数据路径和市场区域，这是所有后续操作的基础[7](@ref)
    # provider_uri = "~/.qlib/qlib_data/cn_data"  # 指定QLib数据文件的路径（通常为中国市场数据）
    # qlib.init(provider_uri=provider_uri, region=REG_CN)  # 初始化Qlib，设置数据源和中国市场区域
